...
/// <summary>
/// <see cref="Avalonia.Controls.Window"/> with R3 support.
/// </summary>
/// <remarks>Inherits from <see cref="Avalonia.ReactiveUI.ReactiveWindow{TViewModel}"/> for compatibility.</remarks>
[PublicAPI]
public class R3Window<TViewModel> :  Avalonia.ReactiveUI.ReactiveWindow<TViewModel>, IR3View<TViewModel>
