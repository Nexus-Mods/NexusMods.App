...
public interface ILoadoutSynchronizer
{
    ...
    /// </summary>
    Task<Loadout.ReadOnly> RunActions(Dictionary<GamePath, SyncNode> syncTree, Loadout.ReadOnly loadout, Action<Percent>? progressUpdater);
    ...
    /// </summary>
    Task<Loadout.ReadOnly> Synchronize(Loadout.ReadOnly loadout, Action<Percent>? progressUpdater = null);
