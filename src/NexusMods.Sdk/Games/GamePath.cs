...
public readonly struct GamePath : IPath<GamePath>, IEquatable<GamePath>, IComparable<GamePath>
{
    ...
    /// <inheritdoc />
    public GamePath Parent => new(LocationId, Path.Parent);

    /// <inheritdoc />
    public GamePath GetRootComponent => new(LocationId, RelativePath.Empty);
    ...
    {
        var id = LocationId;
        var root = new GamePath(id, RelativePath.Empty);
