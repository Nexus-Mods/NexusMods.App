...
public sealed class MountAndBlade2BannerlordModInstallerOld : IModInstaller
{
    private readonly LauncherManagerFactory _launcherManagerFactory;

    public MountAndBlade2BannerlordModInstallerOld(LauncherManagerFactory launcherManagerFactory)
    {
