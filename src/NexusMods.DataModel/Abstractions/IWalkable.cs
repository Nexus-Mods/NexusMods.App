...
{
    /// <summary>
    /// Goes over each item in the collection, firing your callback function.
    /// A 'state' parameter can be specified, which can hold shared state between individual callback invocations.
    ///
