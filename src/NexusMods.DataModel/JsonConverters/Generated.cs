...
public class NexusMods_DataModel_Abstractions_EntityConverter : JsonConverter<NexusMods.DataModel.Abstractions.Entity> {
  public static void ConfigureServices(IServiceCollection services) {
    ...
    services.AddSingleton<JsonConverter, NexusMods_DataModel_Loadouts_LoadoutRegistryConverter>();
    ...
    switch (value) {
      ...
      case NexusMods.DataModel.ArchiveContents.AnalyzedArchive v2:
        JsonSerializer.Serialize(writer, v2, options);
         return;
      case NexusMods.DataModel.Loadouts.Loadout v3:
        JsonSerializer.Serialize(writer, v3, options);
         return;
      case NexusMods.DataModel.Loadouts.LoadoutRegistry v4:
  ...
  public class NexusMods_DataModel_ArchiveContents_AnalyzedFileConverter : JsonConverter<NexusMods.DataModel.ArchiveContents.AnalyzedFile> {
    ...
    public class NexusMods_DataModel_ArchiveContents_FileContainedInConverter : JsonConverter<NexusMods.DataModel.ArchiveContents.FileContainedIn> {
      ...
      public class NexusMods_DataModel_Loadouts_LoadoutConverter : JsonConverter<NexusMods.DataModel.Loadouts.Loadout> {
        ...
        public class NexusMods_DataModel_Loadouts_LoadoutRegistryConverter : JsonConverter<NexusMods.DataModel.Loadouts.LoadoutRegistry> {
          private readonly Lazy<IDataStore> _store;
          public NexusMods_DataModel_Loadouts_LoadoutRegistryConverter(IServiceProvider provider) {
            _store = new Lazy<IDataStore>(provider.GetRequiredService<IDataStore>);
          }
          public override NexusMods.DataModel.Loadouts.LoadoutRegistry Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) {
            if (reader.TokenType != JsonTokenType.StartObject)
              throw new JsonException();
            ...
            return new NexusMods.DataModel.Loadouts.LoadoutRegistry {
              Lists = listsProp,
              Store = _store.Value
              };
            }
            public override void Write(Utf8JsonWriter writer, NexusMods.DataModel.Loadouts.LoadoutRegistry value, JsonSerializerOptions options) {
              writer.WriteStartObject();
