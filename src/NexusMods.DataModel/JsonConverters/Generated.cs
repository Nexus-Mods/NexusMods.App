...
public class NexusMods_DataModel_Abstractions_EntityConverter : JsonConverter<NexusMods.DataModel.Abstractions.Entity> {
  ...
  public override NexusMods.DataModel.Abstractions.Entity Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) {
    ...
    switch(type) {
      case "NexusMods.DataModel.LoadoutRegistry":
...
public class NexusMods_DataModel_ArchiveContents_AnalyzedArchiveConverter : JsonConverter<NexusMods.DataModel.ArchiveContents.AnalyzedArchive> {
  ...
  public class NexusMods_DataModel_ArchiveContents_AnalyzedFileConverter : JsonConverter<NexusMods.DataModel.ArchiveContents.AnalyzedFile> {
    ...
    public class NexusMods_DataModel_ArchiveContents_FileContainedInConverter : JsonConverter<NexusMods.DataModel.ArchiveContents.FileContainedIn> {
      ...
      public class NexusMods_DataModel_ModLists_ListRegistryConverter : JsonConverter<LoadoutRegistry> {
        private readonly Lazy<IDataStore> _store;
        public NexusMods_DataModel_ModLists_ListRegistryConverter(IServiceProvider provider) {
          _store = new Lazy<IDataStore>(provider.GetRequiredService<IDataStore>);
        }
        public override LoadoutRegistry Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) {
          if (reader.TokenType != JsonTokenType.StartObject)
            throw new JsonException();
          ...
          public override void Write(Utf8JsonWriter writer, LoadoutRegistry value, JsonSerializerOptions options) {
            writer.WriteStartObject();
            writer.WriteString("$type", "NexusMods.DataModel.LoadoutRegistry");
            writer.WritePropertyName("Lists");
            JsonSerializer.Serialize<EntityDictionary<LoadoutId,Loadout>>(writer, value.Lists, options);
            writer.WriteEndObject();
          }
        }
        public class NexusMods_DataModel_ModLists_ModConverter : JsonConverter<Mod> {
          private readonly Lazy<IDataStore> _store;
          ...
          public class NexusMods_DataModel_ModLists_ModFiles_FromArchiveConverter : JsonConverter<FromArchive> {
            private readonly Lazy<IDataStore> _store;
            ...
            public class NexusMods_DataModel_ModLists_ModFiles_GameFileConverter : JsonConverter<GameFile> {
              private readonly Lazy<IDataStore> _store;
              public NexusMods_DataModel_ModLists_ModFiles_GameFileConverter(IServiceProvider provider) {
                _store = new Lazy<IDataStore>(provider.GetRequiredService<IDataStore>);
              }
              public override GameFile Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) {
                if (reader.TokenType != JsonTokenType.StartObject)
                  throw new JsonException();
                Hash hashProp = default;
                ...
                public override void Write(Utf8JsonWriter writer, GameFile value, JsonSerializerOptions options) {
                  writer.WriteStartObject();
              ...
              public class NexusMods_DataModel_ModLists_ModListConverter : JsonConverter<Loadout> {
                private readonly Lazy<IDataStore> _store;
                public NexusMods_DataModel_ModLists_ModListConverter(IServiceProvider provider) {
                  _store = new Lazy<IDataStore>(provider.GetRequiredService<IDataStore>);
                }
                public override Loadout Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) {
                  if (reader.TokenType != JsonTokenType.StartObject)
                    throw new JsonException();
                  string changemessageProp = default;
                  GameInstallation installationProp = default;
                  DateTime lastmodifiedProp = default;
                  LoadoutId modlistidProp = default;
                  ...
                  while (true) {
                    ...
                    switch (prop) {
                      ...
                      case "LastModified":
                        ...
                        break;
                      case "LoadoutId":
                        modlistidProp = JsonSerializer.Deserialize<LoadoutId>(ref reader, options);
                        break;
                      case "Mods":
                  ...
                  public override void Write(Utf8JsonWriter writer, Loadout value, JsonSerializerOptions options) {
                    writer.WriteStartObject();
