...
public class DownloadVersionViewModel : AViewModel<IDownloadVersionViewModel>, IDownloadVersionViewModel, IComparableColumn<IDownloadTaskViewModel>
{
    [Reactive]
    ...
    public DownloadVersionViewModel()
    {
