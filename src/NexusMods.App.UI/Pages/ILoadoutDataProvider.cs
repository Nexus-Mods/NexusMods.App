...
public static class LoadoutDataProviderHelper
{
    ...
    public static LoadoutItemModel ToLoadoutItemModel(IConnection connection, LibraryLinkedLoadoutItem.ReadOnly libraryLinkedLoadoutItem, IServiceProvider serviceProvider)
    {
        ...
        return ToLoadoutItemModel(connection, libraryLinkedLoadoutItem.AsLoadoutItemGroup(), serviceProvider);
    ...
    private static LoadoutItemModel ToLoadoutItemModel(IConnection connection, LoadoutItemGroup.ReadOnly loadoutItemGroup, IServiceProvider serviceProvider)
    {
        ...
        var model = new LoadoutItemModel(loadoutItemGroup.Id, serviceProvider, connection)
        {
