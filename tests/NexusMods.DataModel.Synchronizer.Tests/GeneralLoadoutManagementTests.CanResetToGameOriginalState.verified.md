...
| Path | Hash | Size | TxId |
| --- | --- | --- | --- |
| {Game}/bin/originalGameFileA.txt | 0xA52B286A3E7F4D91 | 12 B | Tx:100000000000005 |
...
| Path | Hash | Size | TxId |
| --- | --- | --- | --- |
| {Game}/bin/originalGameFileA.txt | 0xA52B286A3E7F4D91 | 12 B | Tx:100000000000007 |
...
| --- | --- | --- | --- |
| {Game}/bin/originalGameFileA.txt | 0xA52B286A3E7F4D91 | 12 B | Tx:100000000000005 |
| {Game}/bin/newFileInGameFolder.txt | 0x2D489D43D46C8849 | 25 B | Tx:10000000000000A |
### Loadout A - (1)
| Path | Hash | Size | TxId |
| --- | --- | --- | --- |
| {Game}/bin/originalGameFileA.txt | 0xA52B286A3E7F4D91 | 12 B | Tx:100000000000007 |
...
| --- | --- | --- | --- |
| {Game}/bin/originalGameFileA.txt | 0xA52B286A3E7F4D91 | 12 B | Tx:100000000000005 |
| {Game}/bin/newFileInGameFolder.txt | 0x2D489D43D46C8849 | 25 B | Tx:10000000000000C |
...
| Path | Hash | Size | TxId |
| --- | --- | --- | --- |
| {Game}/bin/originalGameFileA.txt | 0xA52B286A3E7F4D91 | 12 B | Tx:100000000000010 |
...
| --- | --- | --- | --- |
| {Game}/bin/originalGameFileA.txt | 0xA52B286A3E7F4D91 | 12 B | Tx:100000000000005 |
| {Game}/bin/newFileInGameFolder.txt | 0x2D489D43D46C8849 | 25 B | Tx:100000000000017 |
