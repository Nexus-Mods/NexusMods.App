...
/// </summary>
public class FileTreeConversionTests : ATreeDataGridSourceFileNodeTest
{
    [Fact]
    public void CanCreateNodes_Basic()
    {
        ...
        // "Textures" Directory
        var texturesDir = node.Children.FirstOrDefault(x => x.FileName == "Textures")!;
        ...
        var meshesDir = node.Children.FirstOrDefault(x => x.FileName == "Meshes")!;
