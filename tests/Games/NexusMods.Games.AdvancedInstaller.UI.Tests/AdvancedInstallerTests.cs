...
// {
//     private readonly AdvancedManualInstallerUI _manualInstallerUi;
...
//         _manualInstallerUi = new AdvancedManualInstallerUI( null!);
...
//     {
//         return await _manualInstallerUi.GetModsAsync(_gameInstallation, LoadoutId.Null, _baseModId, _archiveFiles);
//     }
//
//     [Fact]
...
// {
//     public static IUnsupportedModPageViewModel VM = null!;
//     public static bool CreateWasCalled;
//
//     public static IUnsupportedModPageViewModel Create(string modName = "")
//     {
...
//         VM = new UnsupportedModPageViewModel("Test Mod");
//     }
// }
//
// public class MockInstallerVMFactory
// {
//     public static IAdvancedInstallerPageViewModel? VM;
//     public static bool CreateWasCalled;
//
//     public static IAdvancedInstallerPageViewModel Create(FileTreeNode<RelativePath, ModSourceFileEntry> archiveFiles,
//         GameLocationsRegister register, string gameName = "", string modName = "")
//     {
//         CreateWasCalled = true;
//         VM = new AdvancedInstallerPageViewModel(modName, archiveFiles, register, gameName);
//         return VM;
//     }
//
//     public static void Reset()
