...
## [0.6.1](https://github.com/Nexus-Mods/NexusMods.App/releases/tag/v0.6.1) - 2024-09-XX
...
![An image showing mods in the Library nested by mod page (left) or ungrouped (right)](./docs/changelog-assets/TreeView.webp)
...
![A collection for Cyberpunk 2077 installed into a loadout.](./docs/changelog-assets/Collection.webp)
...
![The diagnostic message for REDmod shown in the Health Check.](./docs/changelog-assets/REDmod.webp)
