...
We've also added our first suggestion diagnostic to recommend a supported SMAPI version:
...
- We've built a new settings backend in preparation for a settings UI that will be added in a future release. See [#1182](https://github.com/Nexus-Mods/NexusMods.App/issues/1182) for more details.
